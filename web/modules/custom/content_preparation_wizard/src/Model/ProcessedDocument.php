...
use Drupal\content_preparation_wizard\Enum\FileType;
use Drupal\content_preparation_wizard\Enum\ProcessingProvider;
...
final class ProcessedDocument {
   ...
   * @param \Drupal\content_preparation_wizard\Enum\FileType $fileType
   *   The type of file that was processed.
   * @param string $markdownContent
   *   The extracted content in Markdown format.
   * @param \Drupal\content_preparation_wizard\Model\DocumentMetadata $metadata
   *   Extracted document metadata.
   * @param \Drupal\content_preparation_wizard\Enum\ProcessingProvider $provider
