...
final class WizardSession {
   ...
   *
   * @var \Drupal\content_preparation_wizard\Model\ProcessedDocument[]
   */
   ...
   *
   * @var \Drupal\content_preparation_wizard\Model\ContentPlan|null
   */
   ...
   *
   * @var \Drupal\content_preparation_wizard\Enum\WizardStep
   */
   ...
   *
   * @return \Drupal\content_preparation_wizard\Model\ContentPlan|null
