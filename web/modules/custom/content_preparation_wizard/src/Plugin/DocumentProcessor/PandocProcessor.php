...
use Drupal\content_preparation_wizard\Service\PandocConverterInterface;
...
class PandocProcessor extends DocumentProcessorBase {
   ...
   *
   * @var \Drupal\content_preparation_wizard\Service\PandocConverterInterface
   */
   ...
   * @param \Drupal\content_preparation_wizard\Service\PandocConverterInterface $pandoc_converter
   *   The Pandoc converter service.
   */
  ...
  public static function create(
    ...
    return new static(
      ...
      $container->get('content_preparation_wizard.pandoc_converter'),
    );
  }
