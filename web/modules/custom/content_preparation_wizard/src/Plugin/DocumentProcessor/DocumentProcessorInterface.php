 ...
 * @see \Drupal\content_preparation_wizard\PluginManager\DocumentProcessorPluginManager
 */
interface DocumentProcessorInterface extends PluginInspectionInterface {
   ...
   *
   * @return \Drupal\content_preparation_wizard\Model\DocumentMetadata
   *   A DocumentMetadata object containing the extracted metadata.
   *
   * @throws \Drupal\content_preparation_wizard\Exception\MetadataExtractionException
