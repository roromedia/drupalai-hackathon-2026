...
use Drupal\content_preparation_wizard\Service\DocumentProcessingServiceInterface;
...
class Step1UploadForm extends FormBase {
   ...
   *
   * @param \Drupal\content_preparation_wizard\Service\WizardSessionManagerInterface $wizardSessionManager
   *   The wizard session manager.
   * @param \Drupal\content_preparation_wizard\Service\DocumentProcessingServiceInterface $documentProcessingService
  ...
  public static function create(ContainerInterface $container): static {
    return new static(
      ...
      $container->get('content_preparation_wizard.document_processing'),
  ...
  public function getFormId(): string {
    return 'content_preparation_wizard_step1';
  }
