...
class ContentPreparationWizard extends FormWizardBase {
   ...
   * @param \Drupal\content_preparation_wizard\Service\WizardSessionManagerInterface|null $wizard_session_manager
   *   The wizard session manager.
  ...
  public function __construct(
    ...
    $this->wizardSessionManager = $wizard_session_manager ?: \Drupal::service('content_preparation_wizard.wizard_session_manager');
  ...
  public static function getParameters() {
    return parent::getParameters() + [
      'wizard_session_manager' => \Drupal::service('content_preparation_wizard.wizard_session_manager'),
  ...
  public function getRouteName(): string {
    ...
    return 'content_preparation_wizard.wizard.step';
  }
  ...
  public function getMachineName() {
    ...
    return $this->machine_name ?: 'content_preparation_wizard';
  }
  ...
  protected function createCanvasPage(array $cached_values): void {
    ...
    \Drupal::logger('content_preparation_wizard')->info(
