...
namespace Drupal\content_preparation_wizard\PluginManager;

use Drupal\content_preparation_wizard\Attribute\DocumentProcessor;
use Drupal\content_preparation_wizard\Plugin\DocumentProcessor\DocumentProcessorInterface;
 ...
 * @see \Drupal\content_preparation_wizard\Plugin\DocumentProcessor\DocumentProcessorBase
 * @see plugin_api
 */
class DocumentProcessorPluginManager extends DefaultPluginManager {
  ...
  public function createInstance($plugin_id, array $configuration = []): DocumentProcessorInterface {
    /** @var \Drupal\content_preparation_wizard\Plugin\DocumentProcessor\DocumentProcessorInterface $instance */
   ...
   *
   * @return \Drupal\content_preparation_wizard\Plugin\DocumentProcessor\DocumentProcessorInterface[]
   ...
   *
   * @return \Drupal\content_preparation_wizard\Plugin\DocumentProcessor\DocumentProcessorInterface|null
