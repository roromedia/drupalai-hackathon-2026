...
final class DocumentProcessedEvent extends Event {
   ...
   * @var string
   */
  public const EVENT_NAME = 'ai_content_preparation_wizard.document_processed';

  /**
   * Constructs a DocumentProcessedEvent.
   *
   * @param \Drupal\ai_content_preparation_wizard\Model\ProcessedDocument $processedDocument
