...
final class ContentPlan {
   ...
   * @param \Drupal\ai_content_preparation_wizard\Enum\PlanStatus $status
   *   The current status of the plan.
   * @param array<\Drupal\ai_content_preparation_wizard\Model\RefinementEntry> $refinementHistory
   ...
   *
   * @param \Drupal\ai_content_preparation_wizard\Model\RefinementEntry $entry
   ...
   *
   * @return \Drupal\ai_content_preparation_wizard\Model\RefinementEntry|null
   ...
   *
   * @return \Drupal\ai_content_preparation_wizard\Model\PlanSection|null
